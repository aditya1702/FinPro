...
class CompanyPageView(TemplateView):
    def get(self, request, **kwargs):
        ...
        # newsapi = NewsApiClient(api_key='"* API Key Here *"')
        # news = newsapi.get_everything(q = request.GET.get('org'),
        #                               language = 'en',
        #                               sources = ' * news sources here *',
        #                               sort_by = 'relevancy',
        #                               from_parameter = date1,
        #                               to = date2,
        #                               page = 1)
        # for article in news['articles']:
        #     data = {}
        ...
        data = pd.read_csv('/Users/adityavyas/Desktop/Data/' + str(organization) + '.csv')
        stock_json = data.to_json()
